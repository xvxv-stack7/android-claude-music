...
"放《桃子》" —— 它自己去把歌点了。你收藏里几十上百首它一次读得完，**整个曲库它也点得到** ——
不限于收藏，搜得到就放得了。

比"帮你按个播放键"多得多：你手上占着、想听的那首不在收藏里、只记得半句歌名 —— 它都办得到。

**📻 而且不占你的屏**

音乐 App 一启动就抢前台，你正看着的东西当场被顶走 —— 这事它不干。
歌在**虚拟副屏**上放，声音照常从你耳机出来，**你手里这块屏一动不动**。

**💬 你听到哪一句，它知道**

不是"知道歌名"那种，是**知道你此刻唱到哪个字**：歌词时间轴跟你手机上的播放进度对齐，
中间差几十秒的坑也补上了。所以它开口，是在对的那一句上开口：
...
你连着耳机、没在忙、时间也对 —— 它按很低的概率挑中一次，放完才让你知道。
不是定时任务在响，是它真在听。见 → [它自己会放歌](#它自己会放歌)
